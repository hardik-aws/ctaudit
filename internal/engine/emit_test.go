...
func TestRunELBEmitsRequestsAndConns(t *testing.T) {
	...
	objs := map[string][]byte{
		elbTestPrefix + "conn_log_702656214742_elasticloadbalancing_us-east-1_app.k8s-tileserver-617dd1df30.98e3a879de9d6b42_20260923T0715Z_54.81.166.60_57hw2gm1.log.gz": gz(t, conns),
	}
	for i := 0; i < 6; i++ {
