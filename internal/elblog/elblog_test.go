...
const (
	albFixedResponse = `http 2026-09-23T07:15:26.379899Z app/k8s-web-0123456789/0123456789abcdef 203.0.113.224:21790 - -1 -1 -1 404 - 127 162 "GET http://k8s-web-0123456789-1234567890.us-east-1.elb.amazonaws.com:80/ HTTP/1.0" "Mozilla/5.0 (compatible; GenomeCrawlerd/1.0; +https://www.nokia.com/genomecrawler)" - - - "Root=1-6ab37c8e-5afd1aca560fd3a825162993" "-" "-" 0 2026-09-23T07:15:26.379000Z "fixed-response" "-" "-" "-" "-" "-" "-" TID_558e26a7adede44b9fdb98006014afcf "-" "-" "-" 192.0.2.60 "-" "-"`
	albForward       = `https 2026-09-23T07:15:47.805298Z app/k8s-web-0123456789/0123456789abcdef 203.0.113.165:5815 10.0.20.37:80 0.001 0.003 0.000 200 200 153 3860 "GET https://tile-staging.terrastride.com:443/data/roads_trails_merged-trails-z18_v2.json HTTP/1.1" "Dart/3.11 (dart:io)" ECDHE-RSA-AES128-GCM-SHA256 TLSv1.2 arn:aws:elasticloadbalancing:us-east-1:111122223333:targetgroup/k8s-tileserv-tileserv-8b701414d0/ce5353cc7101de6d "Root=1-6ab37ca3-72b3ccd0353538ac305db394" "tile-staging.terrastride.com" "arn:aws:acm:us-east-1:111122223333:certificate/34ecc395-417d-479a-b9e3-2c03c1047f42" 2 2026-09-23T07:15:47.801000Z "forward" "-" "-" "10.0.20.37:80" "200" "-" "-" TID_d7917035eabacb42bea251b01fb60ab4 "-" "-" "-" 192.0.2.60 "-" "-"`
	albMalformed     = `http 2026-09-23T07:17:32.454551Z app/k8s-web-0123456789/0123456789abcdef 203.0.113.224:25824 - -1 -1 -1 400 - 0 272 "- http://k8s-web-0123456789-1234567890.us-east-1.elb.amazonaws.com:80- -" "-" - - - "-" "-" "-" - 2026-09-23T07:17:31.697000Z "-" "-" "-" "-" "-" "-" "-" TID_7d15a1935077a44b91952330c3dc3ed8 "-" "-" "-" 192.0.2.60 "-" "-"`
	...
	albKey     = "AWSLogs/111122223333/elasticloadbalancing/us-east-1/2026/09/23/111122223333_elasticloadbalancing_us-east-1_app.k8s-web-0123456789.0123456789abcdef_20260923T0715Z_192.0.2.60_4k2a9x1b.log.gz"
...
func TestParseALBForward(t *testing.T) {
	...
	checks := map[string][2]string{
		"Type":        {e.Type, "https"},
		"LB":          {e.LB, "app/k8s-web-0123456789/0123456789abcdef"},
		"ClientIP":    {e.ClientIP, "203.0.113.165"},
		"ClientPort":  {e.ClientPort, "5815"},
		"Target":      {e.Target, "10.0.20.37:80"},
		...
		"TargetList":  {e.TargetList, "10.0.20.37:80"},
...
func TestParseALBFixedResponse(t *testing.T) {
	...
	if e.Host != "k8s-web-0123456789-1234567890.us-east-1.elb.amazonaws.com" || e.Path != "/" {
...
func TestParseALBMalformedRequest(t *testing.T) {
	...
	if e.URL != "http://k8s-web-0123456789-1234567890.us-east-1.elb.amazonaws.com:80-" {
		t.Errorf("URL = %q", e.URL)
	}
	if e.Host != "k8s-web-0123456789-1234567890.us-east-1.elb.amazonaws.com" {
...
func TestKeyHelpers(t *testing.T) {
	...
	for _, k := range []string{
		"AWSLogs/111122223333/ELBAccessLogTestFile",
		"AWSLogs/111122223333/CloudTrail/us-east-1/2026/09/23/111122223333_CloudTrail_us-east-1_20260923T0000Z_abc.json.gz",
...
const (
	connKey = "AWSLogs/111122223333/elasticloadbalancing/us-east-1/2026/09/23/" +
		"conn_log_111122223333_elasticloadbalancing_us-east-1_app.k8s-web-0123456789.0123456789abcdef_20260923T0715Z_192.0.2.66_57hw2gm1.log.gz"
	connTLS    = `2026-09-23T07:11:27.691358Z 198.18.71.40 64326 443 TLSv1.2 ECDHE-ECDSA-AES128-GCM-SHA256 0.337 "-" - - Success TID_9f39d9aa6a47774d97089313f949866b secp256r1 app/k8s-web-0123456789/0123456789abcdef 192.0.2.57`
	connPlain  = `2026-09-23T07:11:32.882572Z 198.51.100.159 61814 80 - - - "-" - - - TID_14bdaac20df9aa4ca3139b3168e4e071 - app/k8s-web-0123456789/0123456789abcdef 192.0.2.57`
	connFailed = `2026-09-23T07:12:01.000000Z 198.51.100.7 50000 443 - - - "-" - - - TID_aa - app/k8s-web-0123456789/0123456789abcdef 192.0.2.57`
)
...
func TestParseALBConn(t *testing.T) {
	...
	checks := map[string][2]string{
		"ClientIP":        {e.ClientIP, "198.18.71.40"},
...
func TestConnLogKey(t *testing.T) {
	...
	if got := LBNameFromKey(connKey); got != "k8s-web-0123456789" {
