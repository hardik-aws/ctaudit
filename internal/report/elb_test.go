...
func sampleELBResult() (engine.ELBResult, Meta) {
	...
	conns := []elblog.Entry{
		...
		},
		{
			...
			ClientIP: "49.36.71.40", ClientPort: "40000", Listener: "443",
	...
	meta := Meta{
		Bucket: "logs", Accounts: []string{"702656214742"}, Regions: []string{"us-east-1"},
...
func TestELBTerminal(t *testing.T) {
	...
	for _, want := range []string{
		...
		"443 TLSv1.3", "443 no TLS", "TOP FAILED HANDSHAKE CLIENT IPS", "49.36.71.40",
	} {
